...
class Product(models.Model):
    ...
    Product_Catergory = models.CharField(max_length=254, default='fresh_food')
    description = models.TextField(max_length=2000)
    origin = models.CharField(max_length=254, default='')
    price = models.DecimalField(max_digits=6, decimal_places=2)
    image = models.ImageField(upload_to='product_images')
    stock = models.IntegerField()
    Unit = models.CharField(default="grams", max_length=254)
    flintsupplierid = models.ForeignKey(User, default=1, verbose_name = "User", on_delete = models.SET_DEFAULT,  related_name='flintwood_supplier')
